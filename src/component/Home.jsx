            ...
            <div className='d-flex align-items-center justify-content-center' style={{ width: '100%', height: '100vh' }}>
                <div className='d-flex flex-column border rounded p-5 border-success'>
                    ...
                    <div className='d-flex'>
                        ...
                        />
                        <button style={{ width: '100px', height: '50px', backgroundColor: 'blue', color: 'white',marginBottom:'20px' }} className='ms-2 btn' onClick={handleAddTodo}>SUBMIT</button>
                    </div>
                    ...
                    <ul >
                            {todos.map(todo => (
                                <li style={{ listStyle: 'none' }} key={todo.id}>
                                    ...
                                    />
                                    <span className='box ms-5' style={{ textDecoration: todo.completed ? 'line-through' : 'none', color:'white' }}>{todo.text}</span>
